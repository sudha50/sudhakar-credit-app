...
void shouldFindByActiveTrue_returnsEmpty() {
    // Given
    // No merchants are persisted in the database
...
void shouldFindByCategory_returnsResult() {
    ...
    // When
    List<Merchant> result = merchantRepository.findByCategory("Food");
...
void shouldFindByCategory_returnsEmpty() {
    ...
    // When
    List<Merchant> result = merchantRepository.findByCategory("NonExistingCategory");
...
void shouldFindByNameIgnoreCase_returnsResult() {
    // Given
    Merchant merchant = new Merchant();
    merchant.setName("Test Merchant_1");
...
void shouldFindByNameIgnoreCase_returnsEmpty() {
    ...
    // When
    Optional<Merchant> result = merchantRepository.findByNameIgnoreCase("Nonexistent Merchant");
